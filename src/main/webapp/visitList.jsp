                    ...
                    <td>
                        ...
                        <c:if test="${!visit.cancelled && !visit.approved}">
                            <form:form class="form-signin" name='approve' method="POST" action="/visits/approve/${visit.id}">
                                <button class="btn btn-primary btn-block" type="submit"><spring:message code="visit.approve"/></button>
                            </form:form>
                            <form:form class="form-signin" name='cancel' method="POST" action="/visits/cancel/${visit.id}">
                                <button class="btn btn-danger btn-block" type="submit"><spring:message code="visit.cancel"/></button>
                            </form:form>
                        </c:if>
                    </td>
                </tr>

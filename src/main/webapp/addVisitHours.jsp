...
<main role="main">
    <section class="container text-center">
        <form:form class="form-signin" name='addVisitHours' method="POST" action="/visitHours/add" modelAttribute="addVisitHours">
            ...
            <div class="form-label-group">
                <form:select path="visitLength" id="visitLength" name="visitLength" class="form-control" placeholder="" required=""
                              autofocus="" >
                ...
                <form:label path="visitLength" for="visitLength"><spring:message code="visitHours.visitLength"/></form:label>
                <form:errors path="visitLength"/>
            </div>
            <div class="form-label-group">
                <form:input path="visitsCount" type="number" min="1" id="visitsCount" name="visitsCount" class="form-control" placeholder="" required=""
                            autofocus="" />
                <form:label path="visitsCount" for="visitsCount"><spring:message code="visitHours.visitsCount"/></form:label>
                <form:errors path="visitsCount"/>
            </div>
            <div class="form-label-group">
                <form:input path="visitCost" type="number" min="1" step="0.01" id="visitCost" name="visitCost" class="form-control" placeholder="" required=""
                            autofocus="" />
            ...
            <button class="btn btn-lg btn-primary btn-block" type="submit"><spring:message code="visitHours.add"/></button>
        </form:form>
    </section>
</main>

...
<div class="container">
	<form:form class="form-signin" name='editUser' method="POST" action="/users/get/${editUser.id}" modelAttribute="editUser">
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit"><spring:message code="editProfile.title"/></button>
	</form:form>
    <form:form class="form-signin" name='deleteUser' method="POST" action="/users/delete/${editUser.id}">
        <button class="btn btn-lg btn-danger btn-block" type="submit"><spring:message code="editProfile.delete"/></button>
    </form:form>
</div>

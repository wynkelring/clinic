...
public class UserValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        if (errors.getErrorCount() == 0) {
            ...
            if (StringUtils.hasText(((User) o).getTelephone()) && !pattern.matcher(((User) o).getTelephone()).matches()) {
            ...
            if (StringUtils.hasText(((User) o).getPassword()) && !pattern.matcher(((User) o).getPassword()).matches()) {

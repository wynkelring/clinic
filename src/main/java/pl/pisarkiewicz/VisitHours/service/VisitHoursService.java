...
public class VisitHoursService implements IVisitHoursService {
  ...
  public VisitHoursService(
      VisitHoursRepository visitHoursRepository,
                    ...
                    emailService.sendEmail(
                        ...
                        "Wizyta u doktora "
                            ...
                            + visit
                                ...
                                .getStartDate()
                                .plusMinutes(
                                    visit.getVisitHours().getVisitLength()
                                        * visit.getNumberInQueue())
                            + " została anulowana");
                  });
  ...
  @Override
  public boolean hasDoctorVisitingHours(
      Long doctorId, LocalDateTime startDate, LocalDateTime endDate) {
    return visitHoursRepository.findCountByDoctorIdAndStartDateAndEndDate(
  ...
  public Page<VisitHours> getVisitHoursNotCancelledForDoctor(Long doctorId, Pageable pageable) {
    return visitHoursRepository.findAllByCancelledIsFalseAndDoctorIdOrderByStartDateDesc(
        doctorId, pageable);
  }

  @Override
  public List<VisitHours> getVisitHoursNotCancelledByDoctor(Long doctorId) {
    return visitHoursRepository
        .findAllByCancelledIsFalseAndDoctorIdAndEndDateAfterOrderByStartDateAsc(
